...
class VideoListFragment : Fragment(), FileListRecyclerAdapter.OnItemClick {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvCategory.text = "Videos"
        ...
        binding.filesList.apply {
            ...
            adapter = FileListRecyclerAdapter(fileList, this@VideoListFragment)
        }
                    ...
                    if (file.isDirectory)
                        ...
                        if (file.name.endsWith("mp4")
                            ...
                            val data = FileModel(
                                ...
                                file.listFiles()?.size
                                    ?: 0,
                                R.drawable.multimedia.toString()
                            )
                            fileList.add(data)
                        }
                    }
