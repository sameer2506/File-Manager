...
class DocumentListFragment : Fragment(), FileListRecyclerAdapter.OnItemClick {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvCategory.text = "Documents"
        ...
        binding.filesList.apply {
            ...
            adapter = FileListRecyclerAdapter(fileList, this@DocumentListFragment)
        }
