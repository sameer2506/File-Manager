...
class ApkListFragment : Fragment(), FileListRecyclerAdapter.OnItemClick {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.filesList.apply {
            ...
            adapter = FileListRecyclerAdapter(fileList, this@ApkListFragment)
        }
